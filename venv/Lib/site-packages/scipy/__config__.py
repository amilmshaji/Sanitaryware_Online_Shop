...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.12.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-u63ta2f1\overlay\Lib\site-packages\pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-a1px0t3e\cp39-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.9",
        },
    }
)
